    ...
    <div className="pt-24">
      <div className="w-full px-2 md:w-[800px] mx-auto">
        ...
        <div className="mt-8 px-3 relative">
          ...
          {!isSameRes && (
            <div className="fixed bottom-10 w-[800px] z-40">
              <div className="w-[500px] bg-white mx-auto p-8 shadow-xl shadow-black/30 ">
                ...
                <div className="flex mt-6 font-semibold gap-6">
                  <button onClick={() => dispatch(checkRes(true))} className="px-20 py-4 border-2 border-[#60B246] text-[#60B246]">NO</button>
        ...
        {cartData.length > 0 && (
          <div className="fixed bottom-0 py-3 px-4 bg-[#60B246] w-[800px] text-white flex justify-between">
